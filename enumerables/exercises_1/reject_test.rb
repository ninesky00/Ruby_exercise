...
class RejectTest < Minitest::Test
  ...
  #this test incorrectly removed "y" from expected
  ...
  def test_remove_dinosaurs
    ...
    # Your code goes here
    notasaurus = animals.reject {|animal| animal.include?"rus"}
  ...
  def test_remove_numbers
    ...
    # Your code goes here
    not_numbers = elements.select {|ele| ele.class == String}
  ...
  def test_remove_animals_starting_with_vowels
    ...
    # Your code goes here
    remaining = animals.reject {|animal| animal.start_with?("a", "e")}
